...
/** userId lives on the Customer (searchable) so later reads — portal, invoice
...
export const createCheckoutSession = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<CheckoutSessionResult> => {
    try {
      ...
      // One-off charges need a human-readable description or the payments
      // dashboard shows "Unknown product". Subscriptions resolve it server-side.
