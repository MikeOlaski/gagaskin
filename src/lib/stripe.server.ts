...
/** All Stripe traffic is proxied through the connector gateway, which holds the
 *  real secret key. The env vars here are gateway connection identifiers. */
...
/** HMAC-SHA256 signature check for webhook deliveries. Independent of the SDK,
